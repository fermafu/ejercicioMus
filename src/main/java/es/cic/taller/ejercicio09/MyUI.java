...
public class MyUI extends UI {
    ...
    protected void init(VaadinRequest vaadinRequest) {
        ...
        sample.addTab(new Pantalla(this, baraja), "Jugador1");
        sample.addTab(new Pantalla(this, baraja), "Jugador2");
        sample.addTab(new Pantalla(this, baraja), "Jugador3");
        sample.addTab(new Pantalla(this, baraja), "Jugador4");
